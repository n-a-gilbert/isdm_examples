...
# select data and constants needed for camera-only model
data_camera_only <- list(y = data$y, 
                         num = data$num, 
                         adj = data$adj,
...
constants_camera_only <- list(ncell = constants$ncell, 
                              ...
                              cell = constants$cell, 
                              ncams = constants$ncams, 
                              neigh = constants$neigh)

# create model
model <- nimble::nimbleModel(code = camera, 
                             data = data_camera_only, 
                             constants = constants_camera_only, 
                             inits = inits())
